    ...
    <div className={styles.background}>
      ...
      <div className={styles.container}>
        ...
        <p>
          ...
          Fähigkeiten mit der Programierung zu kombinieren. <br /><br />Ich bin ein
          kommunikativer, hilfsbereiter und zuverlässiger Mensch und bin immer
          bereit, meine Fähigkeiten zu erweitern und mich an neuen
          ...
          arbeiten. <br /><br />Habe ich Ihr Interesse geweckt? <br />Dann kontaktieren Sie mich
          doch gerne über <a href="mailto:steffenlemke1@gmx.de">Email</a> oder
          über meine <a href="tel:+4915224321692">Handynummer</a>
        </p>
      </div>
    </div>
  );
